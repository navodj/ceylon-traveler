...
// I've renamed LandingPage to Home to match your file name 'home.tsx'
const Home = () => {
    const router = useRouter();

    const handleSearch = () => {
        router.push('../trip'); // This navigates to userinputs.tsx
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.heroSection}>
                    ...
                    <TouchableOpacity style={styles.planButton} onPress={handleSearch}>
...
const styles = StyleSheet.create({
    ...
    planButton: {
        marginTop: 20,
        backgroundColor: '#007AFF', // You can change this color
        paddingVertical: 12,
